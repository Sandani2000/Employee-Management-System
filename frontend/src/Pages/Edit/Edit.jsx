    ...
    axios
      ...
      .then((res) => {
        setData({
          ...
          empfName: "Sandali",
          emplName: "Anjana",
          empEmail: "sandali@gmail.com",
          empHiringDate: "2020.04.14",
          empBirthday: "2000.05.29",
          empUsername: "empployee@gmail.com",
          empPassword: "employeee@123",
          empDesignation: "Hotel Manager",
          empGender: "Female",
          empDepartement: "Hotel",
          empPhone: res.data.empPhone,
        });
        console.log(res.data.empfName);
